# Come produrre?
- L'imprenditore è tenuto a decidere con *quali* e *quanti* fattori produttivi realizzare la produzione e egli sceglierà in base alla combinazione più congeniale di capitale e lavoro rispetto alla sua impresa
- Va specificato come la combinazione che ha più quantità non è necessariamente la combinazione migliore per i seguenti motivi:
	- I fattori produttivi hanno produttività diversa
	- Per la legge dei rendimenti decrescenti la produttività di un fattore *inizialmente è crescente*, ma da una *certa quantità in poi* tende a *diminuire* per ogni unità aggiuntiva
...
# La scelta ottimale secondo il metodo delle produttività marginali ponderate
## Analisi senza considerare il prezzo
- Facendo un analisi simile a quella compiuta con [[3-La teoria cardinalista del consumatore#Esempio|l'utilità marginale]] l'imprenditore trovatosi a comparare fattori produttivi sceglierebbe in base alla produttività seguendo il seguente ordine
![[TabellaDelleProduttivitaMarginali.png]]
- L'equilibrio dei fattori produttivi sarebbe esprimibile con la seguente formula
$$P1=P2=...=Pn$$
## Analisi considerando il prezzo
- è il rapporto tra la produttività e il prezzo del fattore produttivo similmente alla [[3-La teoria cardinalista del consumatore#Utilità marginale ponderata|utilità marginale ponderata]]
$$Produttività MarginalePonderata = \frac{Produttività Marginale}{PrezzoDelFattoreProduttivo}$$
- L'equilibrio dei fattori produttivi sarebbe esprimibile con la seguente formula
...
### Combinazioni di fattori produttivi che realizzano gli stessi risultati

| Lavoratore specializzato | Lavoratore non specializzato |
| ------------------------ | ---------------------------- |
| 0                        | 2000                         |
| 300                      | 1400                         |
| 500                      | 1000                         |
