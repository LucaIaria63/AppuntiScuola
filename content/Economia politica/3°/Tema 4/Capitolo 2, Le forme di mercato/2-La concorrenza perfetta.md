# Caratteristiche
## Atomizzazione dell'offerta e della domanda
Tutti i soggetti devono essere piccoli
## Piccole imprese
Le imprese sono piccole
## Assenza di barriere di ingresso
Non ci deve essere presente alcun ostacolo per entrare/uscire dal mercato per le imprese
## Trasparenza di informazioni
Ogni operatore deve essere a conoscenza di tutte le informazioni che riguardano il mercato (per esempio prezzo e qualità)
## Omogeneità dei beni
I beni venduti sono perfettamente uguali
## Il prezzo è spontaneo
Nessun operatore può alterare il prezzo individualmente
...
- L'entrata sul mercato è libera
- L'uscita del mercato è senza costi
- è possibile entrare e uscire dal mercato, anche per poco tempo
- I tempi richiesti all'impresa esistente per ridurre i prezzi devono essere più lunghi di quelli necessari all'impresa entrante per cambiare la produzione